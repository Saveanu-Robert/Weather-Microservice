...
A production-ready RESTful microservice for weather data management. Integrates with WeatherAPI.com to fetch current weather and forecasts, with local caching and persistence.
