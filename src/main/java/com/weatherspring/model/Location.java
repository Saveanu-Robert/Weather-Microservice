...
/**
 * Geographical location used for weather tracking and forecasts.
 * Stores the location's name, country, coordinates, and optional region information.
 */
@Entity
@Table(name = "locations",
    ...
    uniqueConstraints = {
        @UniqueConstraint(name = "uk_location_name_country", columnNames = {"name", "country"})
    }
)
@Getter
