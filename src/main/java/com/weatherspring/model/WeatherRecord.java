 ...
 *
 * Stores temperature, humidity, wind, precipitation, and other weather conditions.
 * Uses EAGER fetch for location since weather records are almost always used with their location data.
 */
@Entity
