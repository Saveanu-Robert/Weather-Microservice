 ...
 *
 * Stores predicted conditions including temperature ranges, precipitation probability,
 * and sunrise/sunset times. Uses EAGER fetch for location since forecasts are almost
 * always used with their location data.
 */
@Entity
@Table(name = "forecast_records",
    ...
    uniqueConstraints = {
        @UniqueConstraint(name = "uk_location_forecast_date",
