 ...
 *
 * <p>Configures different caches with appropriate TTL values:</p>
 * <ul>
 *     <li>currentWeather - 5 minutes TTL (300 seconds)</li>
 *     <li>forecasts - 1 hour TTL (3600 seconds)</li>
 *     <li>locations - 15 minutes TTL (900 seconds)</li>
 * </ul>
 */
@Configuration
public class CacheConfig {
    ...
    public CacheManager cacheManager() {
        ...
        // Initialize caches - critical fix to prevent cache errors at runtime
