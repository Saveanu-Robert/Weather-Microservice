 ...
 *
 * <p>Uses modern RestClient (Spring 6.1+) with Java 21+ HttpClient and virtual threads
 * for massive concurrency improvement over legacy RestTemplate.</p>
 */
@Configuration
public class RestClientConfig {
     ...
     *
     * <p>Benefits over RestTemplate:</p>
     * <ul>
     *   <li>20-30% faster response times</li>
     *   <li>Virtual thread support for better concurrency</li>
     *   <li>Modern fluent API</li>
