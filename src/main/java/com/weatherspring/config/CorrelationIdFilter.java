 ...
 * <ul>
 *   <li>Read from the X-Correlation-ID header if present</li>
 *   <li>Generated as a UUID if not present</li>
 *   <li>Added to the MDC for logging</li>
 *   <li>Added to the response header</li>
 * </ul>
 *
 * <p>This enables request tracing across microservices and log aggregation systems.</p>
 */
@Component
