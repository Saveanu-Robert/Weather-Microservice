 ...
 *
 * <p>All endpoints return {@link CompletableFuture} which allows:</p>
 * <ul>
 *     <li>Non-blocking request processing - frees up request threads immediately</li>
 *     <li>Better scalability under high load</li>
 *     <li>Client can poll or wait for completion</li>
 *     <li>Perfect for batch/bulk operations that take time</li>
 * </ul>
 *
 * <p>Spring MVC automatically handles CompletableFuture return types by:</p>
 * <ul>
 *     <li>Returning 200 OK immediately with async processing</li>
 *     <li>Completing the response when the future completes</li>
 *     <li>Handling errors if the future fails</li>
 * </ul>
 */
@RestController
@RequestMapping("/api/async")
@Tag(name = "Async Bulk Operations", description = "Asynchronous bulk weather operations using virtual threads")
@Slf4j
...
public class AsyncBulkController {
    ...
    @Operation(
            ...
            description = "Asynchronously fetches current weather for multiple locations. " +
    ...
    public CompletableFuture<List<WeatherDto>> bulkWeatherAsync(
            ...
            @RequestParam @NotEmpty @Size(max = 100, message = "Maximum 100 locations per request") List<String> locations,
    ...
    @Operation(
            ...
            description = "Asynchronously fetches forecasts for multiple locations. " +
    ...
    public CompletableFuture<List<List<ForecastDto>>> bulkForecastAsync(
        ...
        log.info("Received async bulk forecast request for {} locations, {} days",
                locations.size(), days);
    ...
    @Operation(
            ...
            description = "Asynchronously updates current weather for saved locations. " +
    ...
    public CompletableFuture<Integer> bulkUpdateWeatherAsync(
            ...
            @RequestBody @NotEmpty @Size(max = 100, message = "Maximum 100 location IDs per request") List<Long> locationIds,
    ...
    @Operation(
            ...
            description = "Asynchronously refreshes forecasts for saved locations. " +
    ...
    public CompletableFuture<Integer> bulkRefreshForecastsAsync(
        ...
        log.info("Received async bulk forecast refresh request for {} locations, {} days",
    ...
    @Operation(
            ...
            description = "Asynchronously refreshes both weather and forecast for ALL saved locations. " +
    ...
    public CompletableFuture<BulkOperationResult> refreshAllAsync(
            @Parameter(description = "Number of forecast days (1-14)", example = "7")
            @RequestParam(defaultValue = "7") @Min(1) @Max(14) int forecastDays) {

        log.info("Received async refresh all locations request with {} forecast days", forecastDays);

        return asyncBulkWeatherService.refreshAllLocationsAsync(forecastDays)
                .thenApply(result -> {
                    log.info("Refresh all completed: success={}, failure={}, total={}",
