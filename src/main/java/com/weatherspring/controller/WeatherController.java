...
/**
 * REST controller for weather data endpoints.
 */
@RestController
...
public class WeatherController {
    ...
    @Operation(summary = "Get current weather by location ID",
    ...
    @Operation(summary = "Get weather history for a location",
    ...
    @Operation(summary = "Get weather history by date range",
