...
public class WeatherMapper {
     ...
     *
     * <p>Format: {@code yyyy-MM-dd HH:mm} (e.g., "2025-12-27 14:30")</p>
     *
     * <p><strong>API-Specific:</strong> This format is specific to WeatherAPI.com's response structure.
     * If the external API changes its date format, this formatter must be updated accordingly.</p>
     *
    ...
    public WeatherDto toDto(@Nullable WeatherRecord weatherRecord) {
        ...
        if (weatherRecord.getLocation() == null) {
            log.error("WeatherRecord {} has null location - likely lazy loading issue", weatherRecord.getId());
