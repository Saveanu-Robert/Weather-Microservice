...
public class ForecastMapper {
    ...
    public ForecastDto toDto(@Nullable ForecastRecord forecastRecord) {
        ...
        if (forecastRecord.getLocation() == null) {
            log.error("ForecastRecord {} has null location - likely lazy loading issue", forecastRecord.getId());
     ...
     */
    @Nullable
    private ForecastRecord fromForecastDay(@Nullable ForecastApiResponse.ForecastDay forecastDay, Location location) {
     ...
     */
    @Nullable
    private ForecastDto toDtoFromForecastDay(@Nullable ForecastApiResponse.ForecastDay forecastDay, String locationName) {
        if (forecastDay == null || forecastDay.getDay() == null) {
            return null;
        }
