 ...
 *
 * <p>This class provides a single source of truth for all validation-related
 * constants used throughout the application, improving maintainability and
 * consistency.</p>
 *
 * <p>Constants are organized by domain:</p>
 * <ul>
 *   <li>Location validation - name length, geographic bounds</li>
 *   <li>Forecast validation - day limits</li>
 * </ul>
 */
public final class ValidationConstants {
    ...
    public static final String LOCATION_NAME_SIZE_MESSAGE =
            "Name must be between " + LOCATION_NAME_MIN_LENGTH + " and " + LOCATION_NAME_MAX_LENGTH + " characters";
    ...
    public static final String COUNTRY_NAME_SIZE_MESSAGE =
            "Country must be between " + COUNTRY_NAME_MIN_LENGTH + " and " + COUNTRY_NAME_MAX_LENGTH + " characters";
