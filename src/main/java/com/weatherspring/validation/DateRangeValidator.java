 ...
 *
 * <p>Enforces maximum date range limits to protect database performance
 * and prevent out-of-memory errors from loading too much data.</p>
 *
 * <p><strong>Default Limits:</strong></p>
 * <ul>
 *     <li>Weather history: 90 days maximum (configurable)</li>
 *     <li>Forecast range: 365 days maximum (configurable)</li>
 * </ul>
 *
 * @since 1.0
 */
public final class DateRangeValidator {
    ...
    /**
     * Maximum number of days allowed for weather history queries.
     * Prevents excessive database loads and memory consumption.
     */
    public static final long MAX_WEATHER_HISTORY_DAYS = 90;

    /**
     * Maximum number of days allowed for forecast queries.
     * Prevents excessive database loads and memory consumption.
     */
