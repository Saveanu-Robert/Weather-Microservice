 ...
 *
 * <p>Validates that a longitude value is:</p>
 * <ul>
 *   <li>Not null</li>
 *   <li>Between -180 and 180 degrees</li>
 * </ul>
 *
...
@Min(value = ValidationConstants.LONGITUDE_MIN, message = ValidationConstants.LONGITUDE_RANGE_MESSAGE)
@Max(value = ValidationConstants.LONGITUDE_MAX, message = ValidationConstants.LONGITUDE_RANGE_MESSAGE)
