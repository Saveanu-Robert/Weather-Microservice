 ...
 * <ul>
 *     <li>Number of successful operations</li>
 *     <li>Number of failed operations</li>
 *     <li>Total number of operations attempted</li>
...
public record BulkOperationResult(
    @Schema(description = "Number of successful operations", example = "45")
    int successCount,

    @Schema(description = "Number of failed operations", example = "5")
    int failureCount,

    @Schema(description = "Total number of operations attempted", example = "50")
    int totalCount
) {
    /**
