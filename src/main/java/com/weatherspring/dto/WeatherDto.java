...
/**
 * Current weather conditions for a location at a specific time.
 *
 * <p>Contains temperature, humidity, wind, precipitation, and atmospheric conditions. The ID
 * and locationId fields will be null when weather is fetched directly from the API without
 * saving to database.
 */
