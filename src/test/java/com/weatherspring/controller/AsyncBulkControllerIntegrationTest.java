...
import com.weatherspring.config.SecurityConfig;
 ...
 * validation constraints, and error scenarios.</p>
 */
...
class AsyncBulkControllerIntegrationTest {
    ...
    void bulkWeatherAsync_WithValidLocations_ReturnsWeatherData() throws Exception {
        ...
        // Act
        MvcResult mvcResult = mockMvc.perform(get("/api/async/weather/bulk")
    ...
    void bulkWeatherAsync_WithSaveToDatabase_PassesSaveFlag() throws Exception {
        ...
        verify(asyncBulkWeatherService).fetchBulkWeatherAsync(
                Collections.singletonList("London"), true);
    }

    @Test
    void bulkWeatherAsync_WithEmptyLocationList_ReturnsBadRequest() throws Exception {
        // Act & Assert
        mockMvc.perform(get("/api/async/weather/bulk")
                        .param("locations", "")
                        .contentType(MediaType.APPLICATION_JSON))
    ...
    void bulkForecastAsync_WithValidLocations_ReturnsForecastData() throws Exception {
        ...
        // Act
        MvcResult mvcResult = mockMvc.perform(get("/api/async/forecast/bulk")
    ...
    void bulkForecastAsync_WithDefaultDays_Uses3Days() throws Exception {
        ...
        verify(asyncBulkWeatherService).fetchBulkForecastAsync(
                Collections.singletonList("London"), 3, false);
    }

    @Test
    void bulkForecastAsync_WithInvalidDays_ReturnsBadRequest() throws Exception {
        // Act & Assert - Days less than 1
        mockMvc.perform(get("/api/async/forecast/bulk")
                        .param("locations", "London")
                        .param("days", "0")
                        .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isBadRequest());
        ...
        verify(asyncBulkWeatherService, never()).fetchBulkForecastAsync(anyList(), anyInt(), anyBoolean());
    }
    ...
    void bulkForecastAsync_WithMaximumDays_AcceptsRequest() throws Exception {
        ...
        verify(asyncBulkWeatherService).fetchBulkForecastAsync(
                Collections.singletonList("London"), 14, false);
    }
    ...
    void bulkUpdateWeatherAsync_WithValidLocationIds_ReturnsSuccessCount() throws Exception {
        ...
        // Act
        MvcResult mvcResult = mockMvc.perform(post("/api/async/weather/update")
                        .contentType(MediaType.APPLICATION_JSON)
    ...
    void bulkUpdateWeatherAsync_WithEmptyList_ReturnsBadRequest() throws Exception {
        ...
        // Act & Assert
        mockMvc.perform(post("/api/async/weather/update")
                        .contentType(MediaType.APPLICATION_JSON)
    ...
    void bulkRefreshForecastsAsync_WithValidLocationIds_ReturnsSuccessCount() throws Exception {
        ...
        // Act
        MvcResult mvcResult = mockMvc.perform(post("/api/async/forecast/refresh")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(objectMapper.writeValueAsString(locationIds))
                        .param("days", "7")
                        .param("save", "true"))
    ...
    void bulkRefreshForecastsAsync_WithInvalidDays_ReturnsBadRequest() throws Exception {
        ...
        // Act & Assert - Days less than 1
        mockMvc.perform(post("/api/async/forecast/refresh")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(objectMapper.writeValueAsString(locationIds))
                        .param("days", "0"))
                .andExpect(status().isBadRequest());
        ...
        verify(asyncBulkWeatherService, never()).bulkRefreshForecastsAsync(anyList(), anyInt(), anyBoolean());
    }
    ...
    void refreshAllAsync_WithValidDays_ReturnsOperationResult() throws Exception {
        ...
        // Act
        MvcResult mvcResult = mockMvc.perform(post("/api/async/refresh-all")
    ...
    void refreshAllAsync_WithInvalidDays_ReturnsBadRequest() throws Exception {
        // Act & Assert - Days less than 1
        mockMvc.perform(post("/api/async/refresh-all")
