...
class ForecastMapperTest {
    ...
    void toDto_WithValidForecastRecord_ReturnsForecastDto() {
        ...
        assertThat(result.getLocationName()).isEqualTo("London");
        assertThat(result.getMaxTemperature()).isEqualTo(18.5);
        assertThat(result.getMinTemperature()).isEqualTo(10.2);
        assertThat(result.getCondition()).isEqualTo("Moderate rain");
        assertThat(result.getSunriseTime()).isEqualTo("06:45");
        assertThat(result.getSunsetTime()).isEqualTo("18:30");
    }
    ...
    void toDtoFromApi_WithValidResponse_ReturnsListOfForecastDtos() {
        ...
        assertThat(dto.getLocationName()).isEqualTo("London");
        assertThat(dto.getMaxTemperature()).isEqualTo(18.5);
        assertThat(dto.getMinTemperature()).isEqualTo(10.2);
    }
