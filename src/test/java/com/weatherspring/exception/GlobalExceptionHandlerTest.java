...
class GlobalExceptionHandlerTest {
    ...
    void setUp() {
        ...
        ReflectionTestUtils.setField(exceptionHandler, "problemBaseUrl",
            "https://weatherspring.com/problems");
    }
    ...
    void handleLocationNotFound_ReturnsProblemDetailWithNotFound() {
        ...
        assertThat(problem.getType()).isEqualTo(URI.create("https://weatherspring.com/problems/location-not-found"));
    ...
    void handleWeatherDataNotFound_ReturnsProblemDetailWithNotFound() {
        ...
        // Assert
        assertThat(problem.getStatus()).isEqualTo(HttpStatus.NOT_FOUND.value());
        assertThat(problem.getType()).isEqualTo(URI.create("https://weatherspring.com/problems/weather-data-not-found"));
    ...
    void handleWeatherApiException_ReturnsProblemDetailWithServiceUnavailable() {
        ...
        assertThat(problem.getType()).isEqualTo(URI.create("https://weatherspring.com/problems/weather-api-error"));
    ...
    void handleIllegalArgument_ReturnsProblemDetailWithBadRequest() {
        ...
        assertThat(problem.getType()).isEqualTo(URI.create("https://weatherspring.com/problems/invalid-argument"));
    ...
    void handleTypeMismatch_ReturnsProblemDetailWithTypeInfo() {
        ...
        // Assert
        assertThat(problem.getStatus()).isEqualTo(HttpStatus.BAD_REQUEST.value());
        assertThat(problem.getType()).isEqualTo(URI.create("https://weatherspring.com/problems/type-mismatch"));
    ...
    void handleGenericException_ReturnsProblemDetailWithInternalServerError() {
        ...
        assertThat(problem.getType()).isEqualTo(URI.create("https://weatherspring.com/problems/internal-server-error"));
