...
class LocationServiceTest {
    ...
    void getAllLocations_ReturnsListOfLocations() {
        ...
        when(locationMapper.toDto(any(Location.class)))
                ...
                .thenReturn(LocationDto.builder().id(2L).name("Paris").build());
    ...
    void updateLocation_WhenLocationExists_ReturnsUpdatedDto() {
        // Arrange
        CreateLocationRequest updateRequest = CreateLocationRequest.builder()
                .name("London Updated")
                .country("United Kingdom")
                .latitude(51.5074)
                .longitude(-0.1278)
        ...
        Location updatedLocationEntity = Location.builder()
                .id(1L)
                .name("London Updated")
                .country("United Kingdom")
                .latitude(51.5074)
        ...
        when(locationMapper.toDto(savedLocation)).thenReturn(
                LocationDto.builder().id(1L).name("London Updated").build()
        );
    ...
    void findOrCreateLocation_WhenLocationExists_ReturnsExistingLocation() {
        ...
        // Act
        Location result = locationService.findOrCreateLocation(
    ...
    void findOrCreateLocation_WhenLocationDoesNotExist_CreatesNewLocation() {
        // Arrange
        when(locationRepository.findByNameAndCountry("Paris", "France"))
