 ...
 *
 * <p>Provides centralized test data to reduce duplication and improve
 * test maintainability. All test data uses realistic values for well-known
 * locations to make tests readable and understandable.</p>
 *
 * <p>Usage:</p>
 * <pre>{@code
 * // Use defaults
...
public final class TestDataFactory {
    ...
    public static final String DEFAULT_FORECAST_DESCRIPTION = "Expect moderate rain throughout the day";
    ...
    /**
     * Creates a default WeatherDto for testing.
     * Uses London location with typical weather values.
     *
    ...
    /**
     * Creates a minimal WeatherDto with only essential fields.
     * Useful for testing basic weather data without full details.
     *
    ...
    public static class WeatherDtoBuilder {
        ...
        public WeatherDto build() {
            return new WeatherDto(
                    id, locationId, locationName, temperature, feelsLike,
                    humidity, windSpeed, windDirection, condition, description,
                    pressureMb, precipitationMm, cloudCoverage, uvIndex, timestamp
            );
        }
    }
    ...
    /**
     * Creates a default ForecastDto for testing.
     * Uses London location with typical forecast values for tomorrow.
     *
    ...
    /**
     * Creates a minimal ForecastDto with only essential fields.
     * Useful for testing basic forecast data without full details.
     *
    ...
    public static class ForecastDtoBuilder {
        ...
        public ForecastDto build() {
            return new ForecastDto(
                    id, locationId, locationName, forecastDate,
                    maxTemperature, minTemperature, avgTemperature,
                    maxWindSpeed, avgHumidity, condition, description,
                    precipitationMm, precipitationProbability, uvIndex,
    ...
    /**
     * Creates a default test LocationDto for testing.
     * Uses London location data.
     *
